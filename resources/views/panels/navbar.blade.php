                            ...
                            <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user"
                               ...
                               aria-expanded="false">
                                <div class="user-nav d-sm-flex d-none">
                                    <span class="user-name font-weight-bolder">{{Auth::user() ? Auth::user()->getFullName() : ''}}</span>
                                    <span class="user-status">{{ Auth::user() && !Auth::user()->isRoleEmpty() ? Auth::user()->role()->first()->name : '' }}</span>
                                </div>
                                <span class="avatar">
              <img class="round"
                   src="{{ Auth::user() && !empty(Auth::user()->profile_image) ? asset('/storage/profile-images/'.Auth::user()->profile_image) : asset('/images/avatars/blank-image.png') }}"
