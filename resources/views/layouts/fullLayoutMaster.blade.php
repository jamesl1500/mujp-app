...
<head>
  ...
  <title>@yield('title') - MUJP</title>
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('frontend/images/favicon/museum-of-jewish-philanthropists-icon-32x32.png')}}">
