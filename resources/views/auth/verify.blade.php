            ...
            <div class="card mb-0">
                <div class="card-body">
                    ...
                    <form class="d-inline" method="POST" action="{{ route('verification.resend') }}">
                        @csrf
                        <button type="submit" class="btn btn-link p-0 m-0 align-baseline custom-link"
                                style="">{{ __('click here to request another') }}</button>.
                    </form>
                    </p>

                    <p class="text-center mt-2">
                        @if (Route::has('login'))
                            <a href="{{route('frontend.home')}}" class="custom-link"> <i
                                        data-feather="chevron-left"></i> Back to Home </a>
                        @endif
                    </p>
