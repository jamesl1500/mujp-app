...
@section('content')
    ...
    <section class="add-cities">
        <div class="card">
            <form id="form-states-store" method="POST" action="{{ route('cities.store') }}" class="needs-validation"
                  novalidate>
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <select class="form-control select2 @error('data_country') is-invalid @enderror"
                                        ...
                                        required>
                                    @include('shared.option-list', ['options' => $countries, 'addEmptyOption' => true, 'selectedValue' => old('data_country') ?  old('data_country') : ($selectedCountryId ? $selectedCountryId : null) ])
                                </select>
                                @error('data_country')
            ...
            if ($('#data_country').val()) {
                ...
                const requestConfig = {
                    ...
                    data: {
                        ...
                        stateId: {{ $currentStateId != null ?  $currentStateId : 'null' }},
                        "_token": "{{ csrf_token() }}"
                    },
